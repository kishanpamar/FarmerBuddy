...
<section id="team" class="py-5 bg-light">
  <div class="container text-center">
    <h1 class="mb-5 font-weight-bold text-success">
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-lg p-4">
          <img src="qtonz2.jpg" alt="Kishan Parmar" class="rounded-circle mx-auto d-block" width="150" height="150">
          <h3 class="mt-3">Kishan Parmar</h3>
          <p class="text-muted">Founder & Developer</p>
          <div class="d-flex justify-content-center">
            <a href="https://www.linkedin.com/in/ankit-upadhyay-25601415b/" class="mx-2 text-primary"><i class="fab fa-linkedin fa-lg"></i></a>
            <a href="https://github.com/Ankkkitt" class="mx-2 text-dark"><i class="fab fa-github fa-lg"></i></a>
            <a href="#" class="mx-2 text-danger"><i class="fab fa-youtube fa-lg"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-lg p-4">
          <img src="nihar.jpg" alt="Nihar Siddhpura" class="rounded-circle mx-auto d-block" width="150" height="150">
          <h3 class="mt-3">Nihar Siddhpura</h3>
          <p class="text-muted">Co-Founder</p>
          <div class="d-flex justify-content-center">
            <a href="#" class="mx-2 text-primary"><i class="fab fa-linkedin fa-lg"></i></a>
            <a href="#" class="mx-2 text-dark"><i class="fab fa-github fa-lg"></i></a>
      ...
      <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-lg p-4">
          <img src="manthan.jpg" alt="Manthan Oza" class="rounded-circle mx-auto d-block" width="150" height="150">
          <h3 class="mt-3">Manthan Oza</h3>
